...
public class MainActivity extends AppCompatActivity
    ...
    Button buttonPerfil, buttonReceita;
    Spinner categorias;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView nope = (ImageView) findViewById(R.id.nope );

        Button curtiu = (Button) findViewById(R.id.likeCurti);
        Button deslike = (Button) findViewById(R.id.desLike);
        ...
        curtiu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (al.size() > 0) {
                    flingContainer.getNextRecipe();
        ...
        flingContainer.setOnItemClickListener(new SwipeFlingAdapterView.OnItemClickListener() {
            ...
            public void onItemClicked(int itemPosition, Object dataObject) {
                ...
                Intent intent = new Intent(view.getContext(), receita.class);
        ...
        ArrayAdapter adapter2 = ArrayAdapter.createFromResource(this, R.array.livro_receitas, android.R.layout.simple_spinner_item);
        ...
        buttonPerfil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(MainActivity.this, TelaPerfil.class);
        ...
        buttonReceita = (Button) findViewById(R.id.buttonReceita);
        buttonReceita.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(MainActivity.this, ReceitasCurtidas.class);
                startActivity(intent1);
                finish();
            }
        });
...
//        ppv.setProfileId(profile.getId());
        ...
        View header = LayoutInflater.from(this).inflate(R.layout.tela_perfil, null);
