...
public class NovaReceita extends AppCompatActivity implements DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        perfilBack = (Button) findViewById(R.id.perfilBack);
        perfilBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(NovaReceita.this, TelaPerfil.class);
